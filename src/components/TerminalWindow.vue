...
const commands: Record<string, () => string[]> = {
  ...
  about: () => [
    ...
    '<span class="text-green-400">│</span>  <span class="text-white">Islam</span> — Full-stack developer, 5+ yrs',
    '<span class="text-green-400">│</span>  Clean code, great UX, ship it.',
    '<span class="text-green-400">│</span>',
    '<span class="text-green-400">│</span>  Reading: <span class="text-[#bbb]">Designing Data-Intensive Apps</span>',
    '<span class="text-green-400">│</span>  Learning: <span class="text-[#bbb]">Rust & WebAssembly</span>',
    '<span class="text-green-400">│</span>  Building: <span class="text-[#bbb]">Real-time collab engine</span>',
    '<span class="text-green-400">└─────────────────────────────────────────┘</span>',
    "",
  ],
  skills: () => [
  ...
  projects: () => [
    "",
    '<span class="text-green-400">[01]</span> <span class="text-white">CloudSync Dashboard</span> — Real-time cloud monitoring',
    '<span class="text-green-400">[02]</span> <span class="text-white">ShopFlow E-Commerce</span> — 10k+ daily transactions',
    '<span class="text-green-400">[03]</span> <span class="text-white">DevConnect Social</span> — Dev social + real-time chat',
    '<span class="text-green-400">[04]</span> <span class="text-white">TaskForge PM</span> — Agile project management',
    '<span class="text-green-400">[05]</span> <span class="text-white">HealthPulse API</span> — Healthcare data platform',
    '<span class="text-green-400">[06]</span> <span class="text-white">BudgetWise Finance</span> — AI-powered finance tracker',
    "",
  ...
  blog: () => [
    ...
    '  <span class="text-white">Why I Switched from REST to tRPC</span>  <span class="text-[#555]">6 min</span>',
    '  <span class="text-white">The CSS Trick That Changed My Layouts</span>  <span class="text-[#555]">4 min</span>',
    '  <span class="text-white">Deploying at 2AM</span>  <span class="text-[#555]">8 min</span>',
    '  <span class="text-white">Building a CLI Tool in Go</span>  <span class="text-[#555]">5 min</span>',
    "",
  ],
  contact: () => [
    "",
    "  Email    → islam@example.dev",
    "  GitHub   → github.com/islam",
    "  LinkedIn → linkedin.com/in/islam",
    "  Twitter  → twitter.com/islam_dev",
    "",
  ],
  neofetch: () => [
    "",
    ...
    '<span class="text-green-400">        ██████████████</span>         <span class="text-green-400">Uptime:</span> 5+ years',
    '<span class="text-green-400">         ████████████</span>          <span class="text-green-400">Packages:</span> node_modules go brr',
    '<span class="text-green-400">           ████████</span>            <span class="text-green-400">Coffee:</span> Pour-over, black',
    "",
  ],
...
onMounted(() => {
  mounted.value = true;
  lines.value = [
    { type: "output", text: '<span class="text-green-400">Welcome to islam\'s terminal.</span>' },
