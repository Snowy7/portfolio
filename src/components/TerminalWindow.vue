...
const commands: Record<string, () => string[]> = {
  ...
  projects: () => [
    "",
    '<span class="text-green-400">[01]</span> <span class="text-white">The Cube</span> — Co-op FPS, Steam, multiplayer',
    '<span class="text-green-400">[02]</span> <span class="text-white">Shell Eco-Marathon</span> — 2nd place, autonomous vehicle',
    '<span class="text-green-400">[03]</span> <span class="text-white">Celestial Escape</span> — Best Quality, game jam',
    '<span class="text-green-400">[04]</span> <span class="text-white">Body Parts</span> — 3 awards, solo game jam',
    '<span class="text-green-400">[05]</span> <span class="text-white">Handyman App</span> — Full-stack service platform',
    '<span class="text-green-400">[06]</span> <span class="text-white">Bright Future</span> — Corporate landing page',
    "",
  ...
  neofetch: () => [
    ...
    '<span class="text-green-400">         ████████████</span>          <span class="text-green-400">Projects:</span> 50+',
    '<span class="text-green-400">           ████████</span>            <span class="text-green-400">Focus:</span> Games · Web · Robotics',
    "",
  ],
